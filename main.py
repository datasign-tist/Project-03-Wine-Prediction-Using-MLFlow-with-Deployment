...
from MLProject.pipeline.Stage04_Data_Modelling import ModelTrainerTrainingPipeline
from MLProject.pipeline.Stage05_Data_Evaluation import ModelEvaluationTrainingPipeline
